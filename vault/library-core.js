...
function showViewer(content, pdfOnlyMode) {
    ...
    if (content.type === 'pdf') {
        ...
        viewerHtml = (content.url.startsWith('data:') || isDirectVideo) ? '<video playsinline style="width: 100%; height: auto; max-height: 90vh; display: block; object-fit: contain; background: #1a1a1a;"><source src="' + content.url + '"></video>' : '<iframe src="' + content.url + '" style="width: 100%; height: 90vh; border: none; display: block;" allowfullscreen></iframe>';
